...
export const add = (history: History, message: ChatMessage, totalTokens: number = 0): History => {
    ...
    if (history.tokens !== totalTokens) {
        Logger.warn("[History] Incorrect calculation of tokens", { tokens: history.tokens, totalTokens })
    }
